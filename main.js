...
const routes = [
    ...
    { path: "create", component: _create_employee_create_employee_component__WEBPACK_IMPORTED_MODULE_2__["CreateEmployeeComponent"] },
...
CreateEmployeeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CreateEmployeeComponent, selectors: [["app-create-employee"]], decls: 18, vars: 3, consts: [[1, "col-md-6", "offset-md-3"], [1, "mt-3"], [3, "ngSubmit"], [1, "form-group"], ["type", "text", "id", "firstname", "name", "firstname", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "text", "id", "lastname", "name", "lastname", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "text", "id", "emailId", "name", "emailId", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "submit", 1, "btn", "btn-success"]], template: function CreateEmployeeComponent_Template(rf, ctx) { if (rf & 1) {
...
class EmployeeDetailsComponent {
    constructor(routs, employeeservice) {
        this.routs = routs;
        this.employeeservice = employeeservice;
    }
    ngOnInit() {
        this.id = this.routs.snapshot.params["id"];
        this.employee = new _employee__WEBPACK_IMPORTED_MODULE_1__["Employee"]();
...
UpdateEmployeeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UpdateEmployeeComponent, selectors: [["app-update-employee"]], decls: 18, vars: 3, consts: [[1, "col-md-6", "offset-md-3"], [1, "mt-3"], [3, "ngSubmit"], [1, "form-group"], ["type", "text", "id", "firstname", "name", "firstname", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "text", "id", "lastname", "name", "lastname", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "text", "id", "emailId", "name", "emailId", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "submit", 1, "btn", "btn-success"]], template: function UpdateEmployeeComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "h3", 1);
...
module.exports = __webpack_require__(/*! C:\Users\I-Phone\Desktop\projectforgit\angular-crud-springboot\src\main.ts */"./src/main.ts");
